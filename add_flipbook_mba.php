...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      $sem = $_GET['semester']
        ...
        ?>
      <li class="item">
        <a href="admin_session_mba.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subid; ?>&session=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
          class="menu-btn">
      ...
      <div class="testbox">
        <form id="createform" method="post" enctype="multipart/form-data">
          ...
          <div class="item">
            ...
            <textarea rows="2" name="flipbook" id="flipbook"></textarea>
            <div class="item">
              <p>subject id</p>
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO session (name,ebook_link,subject_id,session_id,unit) VALUES ('$session','$flipbook','$subjectid','$sessionid','$unit')";
