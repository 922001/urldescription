  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <li class="item">
        ...
        <a href="admin_unitcard.php?user_id=<?php echo $enid; ?>&department=<?php echo $department; ?>&subject_id=<?php echo  $var_value ; ?>&semester=<?php echo $semester ; ?>" class="menu-btn">
