...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li class="item">
                <a href="add_flipbook_mba.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&session=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
                    class="menu-btn">
            ...
            <li class="item">
                <a href="quiz_new12.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&session=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
                    class="menu-btn">
            ...
            ?>
            <li class="item">
                <a href="admin_unitcard_mba.php?user_id=<?php echo $enid; ?>&department=MBA&subject_id=<?php echo $subId; ?>&semester=<?php echo $sem; ?>"
                    class="menu-btn">
 ...
 <br>";
  ...
  <div class='card1'>
 <center>
 <a href='admin_video1_mba.php?user_id=$enid&subject_id=$subId&session_id=$sessionName&unit=$unitName&semester=$sem'>
