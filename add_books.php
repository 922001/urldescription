...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <li class="item">
        <a href="lib.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $dep; ?>"
          class="menu-btn">
    ...
    <div class="box-container">
      <div class="testbox">
        <form id="createform" method="post">
          ...
          <div class="item">
            <p>image</p>
            <input type="text" name="book_img" id="book_img" placeholder="image" required>
          </div>
          <div class="item">
            <p>Enter the book link</p>
            <input type="text" name="book_link" id="book_link" placeholder="book link" required>
          </div>
    ...
    function createData() {
      $('#createform').click(
        function (e) {
          ...
          $.ajax({
            type: "POST",
            url: '/lmscres/books_creation.php?user_id=<?php echo $_GET['user_id']; ?>',
            data: $(this).serialize(),
