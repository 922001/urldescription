...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <li class="item">
                <a href="add_flipbook.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&session=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
                    class="menu-btn">
            ...
            <li class="item">
                <a href="quiz_new123.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&session=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>" class="menu-btn">
            ...
            ?>
            <li class="item">
                <a href="admin_unitcard.php?user_id=<?php echo $enid; ?>&department=MCA&subject_id=<?php echo $subId; ?>&semester=<?php echo $sem; ?>"
                    class="menu-btn">
 ...
 <br>";
  ...
  <div class='card1'>
 <center>
 <a href='admin_video1.php?user_id=$enid&subject_id=$subId&session_id=$sessionName&unit=$unitName&semester=$sem'>
...
<div class='card1'>
 ...
 <a href='quiz.php?user_id=$enid&subject_id=$subId&unit=$unitName&session=$sessionName&semester=$sem&n=1'>
