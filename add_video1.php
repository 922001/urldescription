...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      $sem = $_GET['semester']
        ...
        ?>
      <li class="item">
        <a href="admin_video1.php?user_id=<?php echo $user['id']; ?>&subject_id=<?php echo $subid; ?>&session_id=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
          class="menu-btn">
  ...
  <div class="container">
    <div class="box-container">
      <div class="testbox">
      <form action="upload.php" method="post" class="dropzone" id="my-dropzone" >
