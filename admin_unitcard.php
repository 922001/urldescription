...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="add_unit.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subjectId; ?>&department=<?php echo $dep; ?>&semester=<?php echo $semester; ?>"
                    class="menu-btn">
            ...
            ?>
            <li class="item">
                <a href="admin_subjects.php?user_id=<?php echo $enid; ?>&department=MCA&semester=<?php echo $semester; ?>"
                    class="menu-btn">
        ...
        <div class="box-container">
            ...
            for ($index = 0; $index <= 2; $index++) {
              ...
              <div class='title'>
                ...
                echo "<a href='admin_session.php?user_id=" . $enid . "&subject_id=$subjectId&unit=$unitIndex&session=1&semester=$semester'>
                <button>session 1</button></a>";
                echo "<a href='admin_session.php?user_id=" . $enid . "&subject_id=$subjectId&unit=$unitIndex&session=2&semester=$semester'>
