...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sec-header">
            <div class="sidebar-btn"><a href="admin_session.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&unit=<?php echo $unit; ?>&session=<?php echo $session; ?>&semester=<?php echo $sem;?>" style="color:white";>
...
<div id='container' class='container'>
        ...
        <h1><?php echo $name ?> - Video Content</h1>
            ...
            <ul class="ulist">
                <li><a href='add_video.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subject_id; ?>&session_id=<?php echo $session_id; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem;?>'>Add</a></li>
                <!-- <li><a href='#'>Edit</a></li> -->
              </ul>
        </div>
          <div class='content'>
          <div class='main-video'>
              <div class='video'>
                  ...
                  <br>
                  <br>
                  <!-- <a href="https://forms.gle/HxQcs3zv6EWxFXo99" width="640" height="579" frameborder="0" marginheight="0" marginwidth="0"Loading…"><h3>Click here to fill up the feedback form </h3></a> -->
