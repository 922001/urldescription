...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      $sem = $_GET['semester']
        ...
        ?>
      <li class="item">
        <a href="admin_video1.php?user_id=<?php echo $enid; ?>&subject_id=<?php echo $subid; ?>&session_id=<?php echo $session; ?>&unit=<?php echo $unit; ?>&semester=<?php echo $sem; ?>"
          class="menu-btn">
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!mysqli_query($conn, $sql)) {
      ...
      echo '<script>alert("video added succesful")</script>';
